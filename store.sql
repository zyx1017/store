...
MySQL - 5.5.27 : Database - store_07
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`store_07` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `category`(`cid`,`cname`) values ('1','手机数码'),('172934bd636d485c98fd2d3d9cccd409','运动户外'),('2','电脑办公'),('3','家具家居'),('4','鞋靴箱包'),('401B8DE77BEE4E94BB97153AD02AA54E','bbbbc'),('5','图书音像'),('59f56ba6ccb84cb591c66298766b83b5','aaaa'),('6','母婴孕婴'),('afdba41a139b4320a74904485bdb7719','汽车用品');
...
insert  into `orderitem`(`itemid`,`quantity`,`total`,`pid`,`oid`) values ('11CC067E8456429BBF69ECCB714223E1',1,2599,'10','D7838DC11C48455495DD1E15B334324B'),('4A47801B15BA4BDDAA7A806896F2317E',1,3499,'18','DF3A9A9526C2426AA9086D464ACF8365'),('543F5F939F234ADB951D27DD39B09363',1,2599,'10','DF3A9A9526C2426AA9086D464ACF8365'),('A933ED645C5F4F30B095DE3C6A78659D',1,2298,'11','D7838DC11C48455495DD1E15B334324B');
...
insert  into `orders`(`oid`,`ordertime`,`total`,`state`,`address`,`name`,`telephone`,`uid`) values ('D7838DC11C48455495DD1E15B334324B','2020-02-05 11:09:04',4897,3,'111','111','111','532C996C47DA41DA908177A242A783BB'),('DF3A9A9526C2426AA9086D464ACF8365','2020-02-05 01:37:36',6098,1,'','','','532C996C47DA41DA908177A242A783BB');
...
insert  into `user`(`uid`,`username`,`password`,`name`,`email`,`telephone`,`birthday`,`sex`,`state`,`code`) values ('373eb242933b4f5ca3bd43503c34668b','ccc','ccc','aaa','bbb@store.com','15723689921','2015-11-04','男',0,'9782f3e837ff422b9aee8b6381ccf927bdd9d2ced10d48f4ba4b9f187edf7738'),('3ca76a75e4f64db2bacd0974acc7c897','bb','bb','张三','bbb@store.com','15723689921','1990-02-01','男',0,'1258e96181a9457987928954825189000bae305094a042d6bd9d2d35674684e6'),('44D96D1399EE48CE887D4BF8EC3B9E96','zyx','123456','zzz','aaa@store.com',NULL,'2020-02-02','男',1,NULL),('532C996C47DA41DA908177A242A783BB','aaa','aaa','haha','aaa@store.com',NULL,'2020-02-01','男',1,NULL),('62145f6e66ea4f5cbe7b6f6b954917d3','cc','cc','张三','bbb@store.com','15723689921','2015-11-03','男',0,'19f100aa81184c03951c4b840a725b6a98097aa1106a4a38ba1c29f1a496c231'),('c95b15a864334adab3d5bb6604c6e1fc','bbb','bbb','老王','bbb@store.com','15712344823','2000-02-01','男',0,'71a3a933353347a4bcacff699e6baa9c950a02f6b84e4f6fb8404ca06febfd6f'),('f55b7d3a352a4f0782c910b2c70f1ea4','aaa','aaa','小王','aaa@store.com','15712344823','2000-02-01','男',1,NULL);
