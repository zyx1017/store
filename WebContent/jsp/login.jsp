...
<div class="row"> 
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" name="username" id="username" placeholder="请输入用户名"  value="${cookie.rememberCookie.value}">
    </div>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="rememberme" value="1" ${not empty cookie.rememberCookie?"checked='checked'" : "" }> 记住用户名
        </label>
      </div>
    </div>
  </div>
